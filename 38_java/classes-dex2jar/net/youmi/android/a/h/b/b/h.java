  ...
  extends net.youmi.android.a.h.b.d
{
  protected JSONObject a(e parame, net.youmi.android.a.h.b paramb, JSONObject paramJSONObject)
  {
    ...
    i2 = net.youmi.android.c.k.d.a(paramb).b();
    i1 = net.youmi.android.c.k.d.a(paramb).c();
    f = net.youmi.android.c.k.d.a(paramb).f();
    ...
    if (m > 0)
    {
      ...
      if (net.youmi.android.c.b.b.a(paramJSONObject, "f", 1) == 0)
      {
        ...
        parame = parame.a(paramJSONObject);
      }
      switch (i.a[parame.ordinal()])
      {
      case 1: 
      case 2: 
        for (;;)
 ...
 * Qualified Name:     net.youmi.android.a.h.b.b.h
